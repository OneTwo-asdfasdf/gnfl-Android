...
private Timer timer;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
				R.drawable.menu_2, //nav menu toggle icon
	...
	private void displayView(int position) {
		...
		case 1:
			...
			break;
		case 2:
			fragment = new Second1Fragment();
			break;
		case 3:
			fragment = new ThirdFragment();
			break;
		case 4:
			fragment = new Fourth1Fragment();
			break;
		case 5:
			fragment = new FivthFragment();
			break;
		case 6:
			fragment = new Sixth1Fragment();
			break;
		case 7:
